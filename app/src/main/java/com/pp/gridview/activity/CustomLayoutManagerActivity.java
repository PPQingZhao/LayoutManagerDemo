...
public class CustomLayoutManagerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pp.gridview.R.layout.activity_customlayoutmanager);
        initView();
        initRecyclerView();
    }
    ...
    private void initRecyclerView() {
        ...
        coverFlowLayoutManager2 = new CoverFlowLayoutManager2(3, 5, CoverFlowLayoutManager2.VERTICAL);
    ...
    BaseAdapter.OnItemClickListener onItemClickListener = new BaseAdapter.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            Toast.makeText(CustomLayoutManagerActivity.this, String.valueOf(position), Toast.LENGTH_SHORT).show();
        }
    };
